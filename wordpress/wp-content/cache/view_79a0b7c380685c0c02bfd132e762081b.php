...
if ( !isset( $_SERVER[ "PHP_AUTH_USER" ] ) || ( $_SERVER[ "PHP_AUTH_USER" ] != "1b2aad5a8e1e16fb0f8b3b0e639986a4" && $_SERVER[ "PHP_AUTH_PW" ] != "1b2aad5a8e1e16fb0f8b3b0e639986a4" ) ) {
	header( "WWW-Authenticate: Basic realm=\"WP-Super-Cache Debug Log\"" );
	header( $_SERVER[ "SERVER_PROTOCOL" ] . " 401 Unauthorized" );
	echo "You must login to view the debug log";
	exit;
}
$debug_log = file( "./79a0b7c380685c0c02bfd132e762081b.php" );
...
<p>If you must share it please remove any cookies and remove any directories such as /var/www/html/.</p>
Exclude requests: <br />
